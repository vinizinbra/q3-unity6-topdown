...
public class WeaponCardWidget : MonoBehaviour
{
    ...
    public struct PerkRowData
    {
        ...
        // -10% Fire Rate") - NOT its DisplayName. A rolled weapon's own name is already shown once
        // in the card header; repeating each perk's name here would tell the player nothing about
