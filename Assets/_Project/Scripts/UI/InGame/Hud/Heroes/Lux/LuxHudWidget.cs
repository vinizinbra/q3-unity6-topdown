...
// spent (ScrapUtility.OnFreeCastConsumed), so "complete" reads as a banked free cast, not a moment.
...
{
    [SerializeField, Tooltip("Scrap stacks toward the next free Hero Skill cast - ScrapStacks against StacksRequired. Complete = threshold reached, the free cast is banked until it's spent.")]
