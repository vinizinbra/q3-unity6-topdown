namespace Quantum
{
    ...
    public class ElementalReactionConfig : AssetObject
    {
        ...
        // Flat knockback scale-up applied to any push landing on a Rift-Marked target, folded into
        // DamageUtility.ResolveKnockbackScale alongside CharacterStats/tier-resistance - stacks
        // multiplicatively with those, not a replacement for them. Read via
        // StatusEffectUtility.IsRiftMarked, not stack count, so it's a flat bonus for 1 or 2 stacks.
        public FP RiftMarkKnockbackMultiplier = FP._1_50;
