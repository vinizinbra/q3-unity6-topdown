namespace Quantum
{
    ...
    public unsafe partial class RageOverdriveSkillAction : SkillActionData
    {
        ...
        // {0} = MaxStacks, {1} = OverdriveMultiplier as a raw multiplier - e.g. "...(up to {0})...
        // multiplies Berserk's own Fire Rate/Move Speed/Reload Speed bonuses by {1}x."
        protected override object[] DescriptionArgs => new object[] { MaxStacks, OverdriveMultiplier };
