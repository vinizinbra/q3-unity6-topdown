namespace Quantum
{
    ...
    public unsafe partial class VortexCrowdDamageSkillAction : SkillActionData
    {
        ...
        // {0} = PerEnemyBonus as a percent, {1} = MaxCount - e.g. "increases by {0}% for each enemy
        // caught beyond the first, capping at {1} enemies caught."
        protected override object[] DescriptionArgs => new object[] { PerEnemyBonus * 100, MaxCount };
