namespace Quantum
{
    ...
    // View-only half of VortexRandomExplosionSkillAction (see the partial declaration in
    // VortexRandomExplosionSkillAction.cs).
    public partial class VortexRandomExplosionSkillAction
    {
