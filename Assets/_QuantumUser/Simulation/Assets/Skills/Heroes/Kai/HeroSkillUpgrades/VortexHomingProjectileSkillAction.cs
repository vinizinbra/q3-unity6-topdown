namespace Quantum
{
    ...
    public unsafe partial class VortexHomingProjectileSkillAction : SkillActionData
    {
        ...
        // {0} = Damage, {1} = SearchRadiusMultiplier (raw multiplier), {2} = TickInterval (seconds) -
        // e.g. "fires a homing projectile ({0} damage) at the nearest enemy within {1}x its pull
        // radius, every {2}s."
        protected override object[] DescriptionArgs => new object[] { Damage, SearchRadiusMultiplier, TickInterval };
