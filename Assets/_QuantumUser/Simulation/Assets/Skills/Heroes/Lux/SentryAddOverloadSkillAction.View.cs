namespace Quantum
{
    ...
    // View-only half of SentryAddOverloadSkillAction (see the partial declaration in
    // SentryAddOverloadSkillAction.cs).
    public partial class SentryAddOverloadSkillAction
    {
