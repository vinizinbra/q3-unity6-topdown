namespace Quantum
{
    ...
    public unsafe partial class SentryAddOverloadSkillAction : SkillActionData
    {
        ...
        // {0} = Damage, {1} = Radius - both flat values (not percents) - e.g. "...the deployed sentry
        // explodes for {0} damage in a {1}-unit radius when it dies."
        protected override object[] DescriptionArgs => new object[] { Damage, Radius };
