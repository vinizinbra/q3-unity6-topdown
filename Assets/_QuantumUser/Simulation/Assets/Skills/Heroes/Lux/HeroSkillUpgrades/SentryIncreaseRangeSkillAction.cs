namespace Quantum
{
    ...
    public unsafe partial class SentryIncreaseRangeSkillAction : SkillActionData
    {
        ...
        // {0} = RangeBonus, a flat bonus (not a percent) added to the sentry's authored Range - e.g.
        // "Adds {0} to the sentry turret's range the next time it's deployed."
        protected override object[] DescriptionArgs => new object[] { RangeBonus };
