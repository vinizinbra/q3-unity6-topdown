namespace Quantum
{
    ...
    public unsafe partial class JuggernautEndExplosionSkillAction : SkillActionData
    {
        ...
        // {0} = Damage, {1} = Radius, {2} = PushDuration - e.g. "Deals {0} damage in a {1}-unit
        // radius around Brutus and pushes caught enemies to the edge over {2}s when the channel
        // ends."
        protected override object[] DescriptionArgs => new object[] { Damage, Radius, PushDuration };
