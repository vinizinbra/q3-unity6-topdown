namespace Quantum
{
    ...
    public unsafe partial class JuggernautStackDamageSkillAction : SkillActionData
    {
        ...
        // {0} = DamagePerUnit - e.g. "Adds {0} damage to the end explosion for every enemy hit by a
        // discharge during the activation."
        protected override object[] DescriptionArgs => new object[] { DamagePerUnit };
