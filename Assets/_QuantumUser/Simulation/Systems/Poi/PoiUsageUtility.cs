namespace Quantum
{
    ...
    public static unsafe class PoiUsageUtility
    {
        ...
        public static void MarkUsed(Frame f, EntityRef player, EntityRef poi, PoiUsagePolicy policy)
        {
            ...
            for (int i = 0; i < entries.Length; i++)
            {
                ...
                entries[i] = new PoiUsageEntry { Poi = poi, UsedAtBreathingIndex = usedAtIndex };
                return;
            }
