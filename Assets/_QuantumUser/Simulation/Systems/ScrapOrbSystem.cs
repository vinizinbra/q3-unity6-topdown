namespace Quantum
{
    ...
    // TrySpawnDrop rolled the drop for) walks within pickup range. Unlike ExpOrbSystem, this never
    ...
    // ExpOrbSystem's own QueryRadiusScale is (a known simplification - see docs/experience-drops.md).
    [Preserve]
