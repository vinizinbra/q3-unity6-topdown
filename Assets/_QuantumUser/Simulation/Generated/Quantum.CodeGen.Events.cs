    ...
    public unsafe partial struct FrameEvents {
      ...
      static partial void GetEventTypeCodeGen(Int32 eventID, ref System.Type result) {
        switch (eventID) {
          ...
          case EventWeaponAnticipationStarted.ID: result = typeof(EventWeaponAnticipationStarted); return;
          ...
          case EventProjectileImpacted.ID: result = typeof(EventProjectileImpacted); return;
          ...
          case EventJuggernautDischargeHit.ID: result = typeof(EventJuggernautDischargeHit); return;
          ...
          case EventProjectileLandingWarning.ID: result = typeof(EventProjectileLandingWarning); return;
          case EventRingWaveExpanding.ID: result = typeof(EventRingWaveExpanding); return;
          case EventRotatingLaserFired.ID: result = typeof(EventRotatingLaserFired); return;
          case EventJoltTriggered.ID: result = typeof(EventJoltTriggered); return;
          case EventThermalShockTriggered.ID: result = typeof(EventThermalShockTriggered); return;
          case EventOverloadTriggered.ID: result = typeof(EventOverloadTriggered); return;
          case EventOverloadChainLink.ID: result = typeof(EventOverloadChainLink); return;
          case EventShatterTriggered.ID: result = typeof(EventShatterTriggered); return;
          ...
          case EventHealingShrineUsed.ID: result = typeof(EventHealingShrineUsed); return;
          ...
          case EventTeamChallengeActivated.ID: result = typeof(EventTeamChallengeActivated); return;
          case EventTeamChallengeStarted.ID: result = typeof(EventTeamChallengeStarted); return;
          case EventTeamChallengeCompleted.ID: result = typeof(EventTeamChallengeCompleted); return;
          case EventTeamChallengeFailed.ID: result = typeof(EventTeamChallengeFailed); return;
      ...
      public EventWeaponAnticipationStarted WeaponAnticipationStarted(EntityRef Entity) {
        var ev = _f.Context.AcquireEvent<EventWeaponAnticipationStarted>(EventWeaponAnticipationStarted.ID);
        ev.Entity = Entity;
        _f.AddEvent(ev);
        return ev;
      }
      ...
      public EventEntityDamaged EntityDamaged(EntityRef Target, EntityRef Owner, FP Damage, QBoolean IsCritical, ElementType Element, QBoolean Silent, QBoolean ReactionProc, QBoolean FrontalReduced, FPVector3 Position, Byte HitIndex) {
      ...
      public EventProjectileImpacted ProjectileImpacted(EntityRef Entity, FPVector3 Position) {
        var ev = _f.Context.AcquireEvent<EventProjectileImpacted>(EventProjectileImpacted.ID);
        ev.Entity = Entity;
        ev.Position = Position;
        _f.AddEvent(ev);
        return ev;
      ...
      public EventJuggernautDischargeHit JuggernautDischargeHit(EntityRef Entity, FPVector3 Position, AssetRef<JuggernautSkillData> Source) {
        var ev = _f.Context.AcquireEvent<EventJuggernautDischargeHit>(EventJuggernautDischargeHit.ID);
        ev.Entity = Entity;
        ev.Position = Position;
        ev.Source = Source;
        _f.AddEvent(ev);
      ...
      public EventRingWaveExpanding RingWaveExpanding(EntityRef Entity, FPVector3 Center, FP HeightOffset, AssetRef<EnemyDeliveryData> Delivery) {
        var ev = _f.Context.AcquireEvent<EventRingWaveExpanding>(EventRingWaveExpanding.ID);
        ev.Entity = Entity;
        ev.Center = Center;
        ev.HeightOffset = HeightOffset;
        ev.Delivery = Delivery;
        _f.AddEvent(ev);
        return ev;
      }
      public EventRotatingLaserFired RotatingLaserFired(EntityRef Entity, FP Length, FP HeightOffset, Byte BeamCount, AssetRef<EnemyDeliveryData> Delivery) {
        var ev = _f.Context.AcquireEvent<EventRotatingLaserFired>(EventRotatingLaserFired.ID);
        ev.Entity = Entity;
        ev.Length = Length;
        ev.HeightOffset = HeightOffset;
        ev.BeamCount = BeamCount;
        ev.Delivery = Delivery;
        _f.AddEvent(ev);
        return ev;
      }
      public EventJoltTriggered JoltTriggered(EntityRef Target, FPVector3 Position) {
        var ev = _f.Context.AcquireEvent<EventJoltTriggered>(EventJoltTriggered.ID);
        ev.Target = Target;
        ev.Position = Position;
        _f.AddEvent(ev);
        return ev;
      }
      public EventThermalShockTriggered ThermalShockTriggered(EntityRef Target, FPVector3 Position) {
        var ev = _f.Context.AcquireEvent<EventThermalShockTriggered>(EventThermalShockTriggered.ID);
        ev.Target = Target;
        ev.Position = Position;
        _f.AddEvent(ev);
        return ev;
      }
      public EventOverloadTriggered OverloadTriggered(EntityRef Origin, FPVector3 OriginPosition) {
        var ev = _f.Context.AcquireEvent<EventOverloadTriggered>(EventOverloadTriggered.ID);
        ev.Origin = Origin;
        ev.OriginPosition = OriginPosition;
        _f.AddEvent(ev);
        return ev;
      }
      public EventOverloadChainLink OverloadChainLink(EntityRef Origin, EntityRef Target, FPVector3 From, FPVector3 To, FP Distance) {
        var ev = _f.Context.AcquireEvent<EventOverloadChainLink>(EventOverloadChainLink.ID);
        ev.Origin = Origin;
        ev.Target = Target;
        ev.From = From;
        ev.To = To;
      ...
      public EventShatterTriggered ShatterTriggered(EntityRef Center, FPVector3 Position, FP Radius) {
        var ev = _f.Context.AcquireEvent<EventShatterTriggered>(EventShatterTriggered.ID);
        ev.Center = Center;
        ev.Position = Position;
        ev.Radius = Radius;
        _f.AddEvent(ev);
      ...
      public EventHealingShrineUsed HealingShrineUsed(EntityRef Player, EntityRef Shrine) {
        var ev = _f.Context.AcquireEvent<EventHealingShrineUsed>(EventHealingShrineUsed.ID);
        ev.Player = Player;
        ev.Shrine = Shrine;
        _f.AddEvent(ev);
        return ev;
      ...
      public EventTeamChallengeActivated TeamChallengeActivated(EntityRef Poi, EntityRef Player) {
        var ev = _f.Context.AcquireEvent<EventTeamChallengeActivated>(EventTeamChallengeActivated.ID);
        ev.Poi = Poi;
        ev.Player = Player;
        _f.AddEvent(ev);
        return ev;
      }
      public EventTeamChallengeStarted TeamChallengeStarted(EntityRef Poi) {
        var ev = _f.Context.AcquireEvent<EventTeamChallengeStarted>(EventTeamChallengeStarted.ID);
        ev.Poi = Poi;
        _f.AddEvent(ev);
        return ev;
      }
      public EventTeamChallengeCompleted TeamChallengeCompleted(EntityRef Poi) {
        var ev = _f.Context.AcquireEvent<EventTeamChallengeCompleted>(EventTeamChallengeCompleted.ID);
        ev.Poi = Poi;
        _f.AddEvent(ev);
        return ev;
      }
      public EventTeamChallengeFailed TeamChallengeFailed(EntityRef Poi) {
        var ev = _f.Context.AcquireEvent<EventTeamChallengeFailed>(EventTeamChallengeFailed.ID);
        ev.Poi = Poi;
        _f.AddEvent(ev);
        return ev;
      }
  ...
  public unsafe partial class EventEntityDamaged : EventBase {
    ...
    public override Int32 GetHashCode() {
      unchecked {
        ...
        hash = hash * 31 + ReactionProc.GetHashCode();
