namespace Quantum
{
    ...
    public unsafe partial class EnemyActionData : AssetObject
    {
        ...
        // = 1) + KnockbackEffectData (Force = Knockback.X, UpwardForce = Knockback.Y) pair
        // reproduces the flat Damage/Knockback fields above exactly - author both onto every action
        // that deals damage/knockback.
