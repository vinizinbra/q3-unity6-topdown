...
|---|---|---|---|
| Basic Weapon | `Assets/QuantumUser/Resources/Weapon/BasicWeapon.asset` | `Assets/QuantumUser/Resources/WeaponViews/BasicWeapon.prefab` | The only weapon in the game today. `BasicWeapon.asset`'s `ViewPrefab` field must point at this prefab. |
