...
- **Simulation** (`Assets/QuantumUser/Simulation`) — the deterministic sim. Compiles to a
...
- **View** (`Assets/QuantumUser/View`) — regular Unity/MonoBehaviour code
...
`Assets/QuantumUser/Entities/*/*.prefab` + matching `*EntityPrototype.qprototype`.
