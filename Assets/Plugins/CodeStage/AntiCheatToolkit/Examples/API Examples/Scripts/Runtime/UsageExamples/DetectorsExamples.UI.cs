	...
	internal partial class DetectorsExamples
	{
		public void DrawUI()
		{
			...
			using (new GUILayout.VerticalScope(GUI.skin.box))
			{
				...
				if (speedHackDetected && SpeedHackDetector.Instance.LastDetectionInfo != null)
				{
					GUILayout.Label(ExamplesGUI.Colorize($"Details: {SpeedHackDetector.Instance.LastDetectionInfo.GetDetectionInfo()}", ExamplesGUI.YellowColor));
				}
				...
				else
				{
					...
					if (timeCheatingDetected && TimeCheatingDetector.Instance.LastDetectionInfo != null)
					{
						GUILayout.Label(ExamplesGUI.Colorize($"Details: {TimeCheatingDetector.Instance.LastDetectionInfo.GetDetectionInfo()}", ExamplesGUI.YellowColor));
					}
				}
#else
				...
				if (obscuredTypeCheatDetected && ObscuredCheatingDetector.Instance.LastDetectionInfo != null)
				{
					GUILayout.Label(ExamplesGUI.Colorize($"Details: {ObscuredCheatingDetector.Instance.LastDetectionInfo.GetDetectionInfo()}", ExamplesGUI.YellowColor));
				}
				...
				if (wallHackCheatDetected && WallHackDetector.Instance.LastDetectionInfo != null)
				{
					GUILayout.Label(ExamplesGUI.Colorize($"Details: {WallHackDetector.Instance.LastDetectionInfo.GetDetectionInfo()}", ExamplesGUI.YellowColor));
				}
				...
				if (injectionDetected && InjectionDetector.Instance?.LastDetectionInfo != null)
				{
					GUILayout.Label(ExamplesGUI.Colorize($"Details: {InjectionDetector.Instance.LastDetectionInfo.GetDetectionInfo()}", ExamplesGUI.YellowColor));
				}
#else
