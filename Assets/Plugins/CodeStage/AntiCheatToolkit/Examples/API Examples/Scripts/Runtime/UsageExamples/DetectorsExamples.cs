...
namespace CodeStage.AntiCheat.Examples
{
	...
	internal partial class DetectorsExamples : MonoBehaviour
	{
		...
		public void OnSpeedHackDetected()
		{
			...
			Debug.Log($"Speed hack Detected! Details:\n{SpeedHackDetector.Instance.LastDetectionInfo}");
		}
		...
		public void OnTimeCheatingDetected()
		{
			...
			Debug.Log($"Time cheating Detected! Details:\n{TimeCheatingDetector.Instance.LastDetectionInfo}");
		}
#endif
		...
		public void OnInjectionDetected()
		{
			...
			Debug.Log($"Injection Detected! Details:\n{InjectionDetector.Instance?.LastDetectionInfo}");
		}
		...
		{
			injectionDetected = true;
			Debug.Log($"Injection Detected With cause: {cause}. Details:\n{InjectionDetector.Instance?.LastDetectionInfo}");
		}
		...
		public void OnWallHackDetected()
		{
			...
			Debug.Log($"Wall hack Detected! Details:\n{WallHackDetector.Instance.LastDetectionInfo}");
		}
		...
		private void SpeedHackDetectorExample()
		{
			...
			// allowing Cool Down after 60 seconds (read more about Cool Down in the User Manual).
		...
		private void ObscuredCheatingDetectorExample()
		{
			...
			// create fake unprivate protected versions of all obscured
