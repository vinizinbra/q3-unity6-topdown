...
namespace CodeStage.AntiCheat.Examples
{
	...
	internal partial class ObscuredPrefsExamples
	{
		...
		private GUIStyle savesListStyle;
		
		public void DrawUI()
		{
			if (savesListStyle == null)
			{
				savesListStyle = new GUIStyle(GUI.skin.label)
				{
					wordWrap = true,
					richText = true,
			...
			using (new GUILayout.VerticalScope())
			{
				using (new GUILayout.VerticalScope(GUI.skin.box))
				{
					...
					{
						GUILayout.Label(regularPrefs, savesListStyle, GUILayout.Width(450));
						using (new GUILayout.VerticalScope())
						{
							using (new GUILayout.HorizontalScope())
							{
				...
				using (new GUILayout.VerticalScope(GUI.skin.box))
				{
					...
					using (new GUILayout.HorizontalScope())
					{
							GUILayout.Label(obscuredPrefs, savesListStyle, GUILayout.Width(450));
						using (new GUILayout.VerticalScope())
						{
							using (new GUILayout.HorizontalScope())
							{
