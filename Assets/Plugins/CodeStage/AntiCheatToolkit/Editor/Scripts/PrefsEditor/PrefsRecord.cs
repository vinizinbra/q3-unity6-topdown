...
namespace CodeStage.AntiCheat.EditorCode
{
	...
	{
		private protected const string DefaultString = "[^_; = ElinaKristinaMyGirlsLoveYou'16 = ;_^]";
		private protected const float DefaultFloat = float.MinValue + 2016.0122f;
		private protected const int DefaultInt = int.MinValue + 20130524;
		private protected const string CantDecrypt = "Can't decrypt with specified key";
