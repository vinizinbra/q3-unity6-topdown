...
namespace CodeStage.AntiCheat.EditorCode.Editors
{
	...
	internal class KeepAliveBehaviourEditor<T> : Editor where T: KeepAliveBehaviour<T>
	{
		...
		public override void OnInspectorGUI()
		{
			...
			{
				EditorGUILayout.LabelField(new GUIContent("Don't forget to start detection!", "You should start detector from code using ObscuredCheatingDetector.StartDetection() method. See User Manual for details."), GUITools.BoldLabel);
		...
		private protected virtual void DrawHeader(string text)
		{
			GUITools.DrawHeader(text);
		}

		private protected virtual bool AdditionalEventsHasListeners()
		{
			return true;
		}

		private protected virtual void FindUniqueDetectorProperties() {}
		private protected virtual bool DrawUniqueDetectorProperties() { return false; }
		private protected virtual void CheckAdditionalEventsForListeners() {}
		private protected virtual void DrawAdditionalEvents() {}
	}
}