	...
	internal class WallHackDetectorEditor : KeepAliveBehaviourEditor<WallHackDetector>
	{
		...
		private protected override bool DrawUniqueDetectorProperties()
		{
			...
			if (checkRaycast.boolValue || checkController.boolValue || checkRigidbody.boolValue)
			{
				...
				{
					EditorGUILayout.LabelField("IgnoreRaycast physics layer should collide with itself to avoid false positives! See User Manual's troubleshooting section for details.", EditorStyles.wordWrappedLabel);
