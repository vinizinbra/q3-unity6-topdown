...
namespace CodeStage.AntiCheat.EditorCode
{
	...
	internal static class ACTkEditorPrefsSettings
	{
		private class FoldoutStorage
		{
			...
			private bool showUnityPrefs;
			public bool ShowUnityPrefs
			{
				get => showUnityPrefs;
				set
				{
					showUnityPrefs = value;
					EditorPrefs.SetBool(ShowUnityPrefsPref, value);
				}
			}
			...
			public FoldoutStorage()
			{
				...
				showUnityPrefs = EditorPrefs.GetBool(ShowUnityPrefsPref);
			}
		}
		...
		private const string ShowUnityPrefsPref = PrefsPrefix + "showUnityPrefs";
		...
		public static bool ShowUnityPrefs
		{
			get => Storage.Value.ShowUnityPrefs;
			set => Storage.Value.ShowUnityPrefs = value;
		}
