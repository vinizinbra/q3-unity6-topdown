...
namespace CodeStage.AntiCheat.Genuine.CodeHash
{
	...
	/// Resulting hash in most cases should match value you get from the <see cref="CodeStage.AntiCheat.EditorCode.PostProcessors.CodeHashGeneratorPostprocessor"/>.
	/// 
	/// <example>
	/// <code>
	/// <![CDATA[
