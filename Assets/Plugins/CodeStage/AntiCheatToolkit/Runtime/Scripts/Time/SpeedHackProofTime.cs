...
namespace CodeStage.AntiCheat.Time
{
	...
	/// </summary>
	/// <remarks>
	/// Requires running <see cref="CodeStage.AntiCheat.Detectors.SpeedHackDetector"/> to operate properly. Make sure to start SpeedHackDetector before calling Init(). <br/>
	...
	public class SpeedHackProofTime : KeepAliveBehaviour<SpeedHackProofTime>
	{
		...
		/// </summary>
		/// Make sure to call it after you setup and run <see cref="CodeStage.AntiCheat.Detectors.SpeedHackDetector"/>.
		...
		private protected override void OnSceneLoaded(Scene scene, LoadSceneMode mode)
		{
