...
namespace CodeStage.AntiCheat.Storage
{
	...
	public class DeviceIdHolder
	{
		...
		/// </summary>
		/// <remarks>
		/// <strong>⚠️ Warning:</strong> All data saved with previous device ID will be considered foreign!
		/// </remarks>
		...
		/// Lock To Device feature without custom <see cref="DeviceId"/> to avoid exception due to Unity API access
