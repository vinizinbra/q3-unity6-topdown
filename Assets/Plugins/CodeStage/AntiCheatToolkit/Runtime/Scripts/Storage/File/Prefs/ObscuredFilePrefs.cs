...
namespace CodeStage.AntiCheat.Storage
{
	...
	public static partial class ObscuredFilePrefs
	{
		...
		/// <strong>📝 Note:</strong> Will fire if same device ID has
		/// changed (pretty rare case though). Read more at <see cref="DeviceLockLevel"/>.
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		/// Use <see cref="Init"/> to set the initial settings.
		/// </remarks>
		public static IObscuredFileSettings CurrentSettings => PrefsFile.CurrentSettings;
		
		/// <summary>
		/// Allows checking if <see cref="Init"/> was called previously.
		/// </summary>
		...
		/// <summary>
		/// Initializes ObscuredFilePrefs with file name set to <see cref="DefaultFileName"/> and default ObscuredFileSettings.
		/// </summary>
		...
		/// <summary>
		/// Initializes ObscuredFilePrefs with file name set to <see cref="DefaultFileName"/> and custom specific settings.
		/// </summary>
		...
		/// </summary>
		/// <param name="fileNameOrPath">File path if using ObscuredFileLocation.Custom, otherwise represents file name to use with set <see cref="ObscuredFileLocation"/> kind.</param>
		/// <param name="settings">Specific custom settings.</param>
		/// <param name="loadPrefs">Pass <c>true</c> to automatically call LoadPrefs().
		/// This may block calling thread, consider using asynchronously for large files.</param>
		...
		/// </summary>
		/// <remarks>
		/// Please call <see cref="Init"/> again if you wish to re-use it.
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		/// <strong>⚠️ Warning:</strong> Unsaved data will be lost!
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		/// Calls <see cref="LoadPrefs"/> internally.
		/// </remarks>
		...
		/// <summary>
		/// <strong>⚠️ Warning:</strong> Use with caution! Removes all keys and values from the prefs.
		/// </summary>
