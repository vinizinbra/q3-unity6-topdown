...
namespace CodeStage.AntiCheat.Storage
{
	...
	public class ObscuredFile
	{
		...
		/// <summary>
		/// Returns true if file at <see cref="FilePath"/> physically exists on disk.
		/// </summary>
		...
		/// <summary>
		/// Creates instance with file name set to <see cref="DefaultFileName"/> and default ObscuredFileSettings.
		/// </summary>
		...
		/// <summary>
		/// Creates instance with file name set to <see cref="DefaultFileName"/> and custom specific settings.
		/// </summary>
